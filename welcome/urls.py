...
urlpatterns = [
    ...
    path('index/car/index/', views.index),
    path('index/car/sell/', views.sell),
    path('index/sell/index/car/', views.car),
    path('car/', views.car),
    path('index/car/sell/index/car/', views.car),
